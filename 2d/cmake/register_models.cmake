...
macro(register_append_c_flags CONFIG)
    if ("${CONFIG}" STREQUAL "ANY")
        list(APPEND DEFAULT_RELEASE_C_FLAGS ${ARGN})
        list(APPEND DEFAULT_DEBUG_C_FLAGS ${ARGN})
    elseif ("${CONFIG}" STREQUAL "RELEASE")
        list(APPEND DEFAULT_RELEASE_C_FLAGS ${ARGN})
    elseif ("${CONFIG}" STREQUAL "DEBUG")
        list(APPEND DEFAULT_DEBUG_C_FLAGS ${ARGN})
...
macro(register_model NAME PREPROCESSOR_NAME)
    ...
    foreach (SRC_FILE ${ARGN})
        list(APPEND IMPL_${MODEL_UPPER}_SOURCES "c_kernels/${NAME}/${SRC_FILE}")
    endforeach ()
...
macro(load_model MODEL)
    if ("${MODEL}" IN_LIST REGISTERED_MODELS)
        ...
        set(MODEL_FILE ${CMAKE_CURRENT_SOURCE_DIR}/c_kernels/${MODEL_LOWER}/model.cmake)
        include_directories(${CMAKE_CURRENT_SOURCE_DIR}/c_kernels/${MODEL_LOWER})
        ...
        set(BIN_NAME ${MODEL_LOWER}-tealeaf)
