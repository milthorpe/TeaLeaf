...
(
  module load mpi
    ...
    test 12 "0" -DMODEL=omp -DCMAKE_C_COMPILER=clang -DCMAKE_CXX_COMPILER=clang++ -DOFFLOAD=NVIDIA:sm_60 -DCXX_EXTRA_FLAGS=--cuda-path=/opt/nvidia/hpc_sdk/Linux_x86_64/2023/cuda/ -DC_EXTRA_FLAGS=--cuda-path=/opt/nvidia/hpc_sdk/Linux_x86_64/2023/cuda/
