...
#pragma acc kernels present(energy[ : xy], density[ : xy], u0[ : xy], u[ : xy])
...
#pragma acc kernels present(density[ : xy], kx[ : xy], ky[ : xy])
...
#pragma acc kernels present(r[ : xy], u[ : xy])
  ...
  double err = 0.0;
#pragma acc kernels loop independent collapse(2) present(u[ : xy], u0[ : xy], kx[ : xy], ky[ : xy], r[ : xy])
