...
#pragma acc data copyin(r[ : n], sd[ : n], kx[ : n], ky[ : n], w[ : n], p[ : n], cheby_alphas[ : settings->max_iters],                     \
                            cheby_betas[ : settings->max_iters], cg_alphas[ : settings->max_iters], cg_betas[ : settings->max_iters])      \
