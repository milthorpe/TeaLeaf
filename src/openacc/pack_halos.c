...
void pack_left(const int x, const int y, const int depth, const int halo_depth, double *field, double *buffer, bool is_offload) {
  const int y_inner = y - 2 * halo_depth;

#pragma acc kernels loop independent if (is_offload) present(field[ : x * y]) copyout(buffer[depth * y_inner])
...
void pack_right(const int x, const int y, const int depth, const int halo_depth, double *field, double *buffer, bool is_offload) {
  const int y_inner = y - 2 * halo_depth;
...
void pack_top(const int x, const int y, const int depth, const int halo_depth, double *field, double *buffer, bool is_offload) {
  const int x_inner = x - 2 * halo_depth;

#pragma acc kernels loop independent if (is_offload) present(field[ : x * y]) copyout(buffer[depth * x_inner])
...
void pack_bottom(const int x, const int y, const int depth, const int halo_depth, double *field, double *buffer, bool is_offload) {
  const int x_inner = x - 2 * halo_depth;
...
void unpack_left(const int x, const int y, const int depth, const int halo_depth, double *field, double *buffer, bool is_offload) {
  const int y_inner = y - 2 * halo_depth;

#pragma acc kernels loop independent if (is_offload) present(field[ : x * y]) copyin(buffer[depth * y_inner])
  for (int jj = halo_depth; jj < y - halo_depth; ++jj) {
...
void unpack_right(const int x, const int y, const int depth, const int halo_depth, double *field, double *buffer, bool is_offload) {
  const int y_inner = y - 2 * halo_depth;
...
void unpack_top(const int x, const int y, const int depth, const int halo_depth, double *field, double *buffer, bool is_offload) {
  const int x_inner = x - 2 * halo_depth;

#pragma acc kernels loop independent if (is_offload) present(field[ : x * y]) copyin(buffer[depth * x_inner])
...
void unpack_bottom(const int x, const int y, const int depth, const int halo_depth, double *field, double *buffer, bool is_offload) {
  const int x_inner = x - 2 * halo_depth;
