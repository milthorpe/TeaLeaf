...
void pack_left(const int x, const int y, const int depth, const int halo_depth, double *field, double *buffer) {
...
void pack_right(const int x, const int y, const int depth, const int halo_depth, double *field, double *buffer) {
  for (int jj = halo_depth; jj < y - halo_depth; ++jj) {
...
void pack_top(const int x, const int y, const int depth, const int halo_depth, double *field, double *buffer) {
...
void pack_bottom(const int x, const int y, const int depth, const int halo_depth, double *field, double *buffer) {
  const int x_inner = x - 2 * halo_depth;
...
void unpack_left(const int x, const int y, const int depth, const int halo_depth, double *field, double *buffer) {
  for (int jj = halo_depth; jj < y - halo_depth; ++jj) {
...
void unpack_right(const int x, const int y, const int depth, const int halo_depth, double *field, double *buffer) {
  for (int jj = halo_depth; jj < y - halo_depth; ++jj) {
...
void unpack_top(const int x, const int y, const int depth, const int halo_depth, double *field, double *buffer) {
  const int x_inner = x - 2 * halo_depth;
...
void unpack_bottom(const int x, const int y, const int depth, const int halo_depth, double *field, double *buffer) {
  const int x_inner = x - 2 * halo_depth;
