...
__global__ void set_chunk_data(int x, int y, double dx, double dy, double *cell_x, double *cell_y, double *cell_dx, double *cell_dy,
                               double *vertex_x, double *vertex_y, double *volume, double *x_area, double *y_area);
...
void kernel_initialise(Settings *settings, int x, int y, double **density0, double **density, double **energy0, double **energy, double **u,
                       ...
                       double **cheby_alphas, double **cheby_betas, double **d_comm_buffer, double **d_reduce_buffer,
...
void pack_or_unpack(Chunk *chunk, Settings *settings, int depth, int face, bool pack, double *field, double *buffer);

__global__ void store_energy(int x, int y, double *energy0, double *energy);
...
__global__ void jacobi_iterate(const int x_inner, const int y_inner, const int halo_depth, const double *kx, const double *ky,
                               const double *u0, const double *r, double *u, double *error);

__global__ void jacobi_init(const int x_inner, const int y_inner, const int halo_depth, const double *density, const double *energy,
                            const double rx, const double ry, double *kx, double *ky, double *u0, double *u, const int coefficient);
...
__global__ void ppcg_calc_ur(const int x_inner, const int y_inner, const int halo_depth, const double *kx, const double *ky,
                             const double *sd, double *u, double *r);

__global__ void ppcg_calc_sd(const int x_inner, const int y_inner, const int halo_depth, const double alpha, const double beta,
                             const double *r, double *sd);
...
void sum_reduce_buffer(double *buffer, double *value, int len);
