...
const char *cuda_codes(int code) {
  switch (code) {
    ...
    case hipErrorInvalidMemcpyDirection:
      return "hipErrorInvalidMemcpyDirection"; // 21
    ...
    case hipErrorSetOnActiveProcess:
      return "hipErrorSetOnActiveProcess";            // 36
    ...
    case hipErrorUnsupportedLimit:
      return "hipErrorUnsupportedLimit"; // 42
    ...
    case hipErrorNoBinaryForGpu:
      return "hipErrorNoBinaryForGpu"; // 48
    ...
    case hipErrorOperatingSystem:
      return "hipErrorOperatingSystem"; // 61
