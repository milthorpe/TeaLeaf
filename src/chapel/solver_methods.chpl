...
module solver_methods {
    ...
    proc copy_u(halo_depth: int, const ref u: [?u_domain] real, ref u0: [u_domain] real) {
    ...
    proc calculate_residual(halo_depth: int(32), const ref u: [?Domain] real, const ref u0: [Domain] real, 
    ...
    proc calculate_2norm(halo_depth: int(32), ref buffer: [?buffer_domain] real, ref norm: real) {
    ...
    proc finalise(x: int(32), y: int(32), halo_depth: int(32), ref energy: [?Domain] real, 
