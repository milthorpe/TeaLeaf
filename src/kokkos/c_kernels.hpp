...
void cheby_init(const int x, const int y, const int halo_depth, const double theta, KView p, KView r, KView u, KView u0, KView w, KView kx,
                KView ky);
...
void cg_init_others(const int x, const int y, const int halo_depth, KView kx, KView ky, KView p, KView r, KView u, KView w, double *rro);
...
void jacobi_init(const int x, const int y, const int halo_depth, const int coefficient, const double rx, const double ry, KView u, KView u0,
                 KView density, KView energy, KView kx, KView ky);
...
void update_left(const int x, const int y, const int halo_depth, KView buffer, const int face, const int depth);

// Updates the local right halo region(s)
void update_right(const int x, const int y, const int halo_depth, KView buffer, const int face, const int depth);

// Updates the local top halo region(s)
void update_top(const int x, const int y, const int halo_depth, KView buffer, const int face, const int depth);

// Updates the local bottom halo region(s)
void update_bottom(const int x, const int y, const int halo_depth, KView buffer, const int face, const int depth);

/* PACK HALOS */

// Packs the top halo buffer(s)
void pack_top(const int x, const int y, const int halo_depth, KView buffer, KView field, const int depth);

// Packs the bottom halo buffer(s)
void pack_bottom(const int x, const int y, const int halo_depth, KView buffer, KView field, const int depth);

// Unpacks the top halo buffer(s)
void unpack_top(const int x, const int y, const int halo_depth, KView buffer, KView field, const int depth);

// Unpacks the bottom halo buffer(s)
void unpack_bottom(const int x, const int y, const int halo_depth, KView buffer, KView field, const int depth);

// Packs the left halo buffer(s)
void pack_left(const int x, const int y, const int halo_depth, KView buffer, KView field, const int depth);

// Packs the right halo buffer(s)
void pack_right(const int x, const int y, const int halo_depth, KView buffer, KView field, const int depth);

// Unpacks the left halo buffer(s)
void unpack_left(const int x, const int y, const int halo_depth, KView buffer, KView field, const int depth);

// Unpacks the right halo buffer(s)
void unpack_right(const int x, const int y, const int halo_depth, KView buffer, KView field, const int depth);
